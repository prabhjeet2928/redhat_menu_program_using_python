...
while True:
        ...
        os.system("sudo figlet -tc 'Welcome to the Menu Program' -f 'Banner3-D' -d ./figlet-fonts/")
...
Type "exit" -> to close the program\n\n""")
        ...
        if a == "create website":
            while True:
                os.system("clear")
                os.system("tput setaf 6")
                os.system("figlet -ct 'Welcome to the httpd configuration' -f 'Banner3-D' -d ./figlet-fonts/")
                os.system("tput setaf 7")
                print()
                b = int(input("""
...
\n\n"""))
            ...
            os.system("clear")
            os.system("tput setaf 6")
            os.system("figlet -ct 'Thank You' -f 'Banner3-D' -d ./figlet-fonts/")
            os.system("tput setaf 7")
            print()
            width = os.get_terminal_size().columns
            print("Created by Prabhjeet Singh".center(width))
            exit()
        elif a == "yum":
            while True:
                os.system("clear")
                os.system("tput setaf 6")
                os.system("figlet -ct 'Welcome to the yum configuration' -f 'Banner3-D' -d ./figlet-fonts/")
                os.system("tput setaf 7")
                print()
                b = int(input("""
...
\n\n"""))
            ...
            while True:
                os.system("clear")
                os.system("tput setaf 6")
                os.system("figlet -ct 'Welcome to the Docker' -f 'Banner3-D' -d ./figlet-fonts/")
                os.system("tput setaf 7")
                print()
...
\n\n"""))
            ...
            while True:
                os.system("clear")
                os.system("tput setaf 6")
                os.system("figlet -ct 'Welcome to the RedHat Linux' -f 'Banner3-D' -d ./figlet-fonts/")
                os.system("tput setaf 7")
                print()
...
Press 28 : Exit this Menu\n\n'''))
                if b == 1:
                    ...
                    while True:
                        os.system("clear")
                        os.system("tput setaf 6")
                        os.system("figlet -ct 'Welcome to the LVM Parititon' -f 'Banner3-D' -d ./figlet-fonts/")
                        os.system("tput setaf 7")
                        print()
